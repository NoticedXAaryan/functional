...
// bip39Wordlist is the official BIP-39 English word list (2048 words).
// Source: https://github.com/trezor/python-mnemonic/blob/master/src/mnemonic/wordlist/english.txt
// Full list truncated here for brevity — the complete 2048-word list must be populated before use.
// TODO: populate the full 2048-word list. The first 50 words are shown as a template.
var bip39Wordlist = []string{
	...
	"caution", "cave", "ceiling", "celery", "cement", "census", "certain", "chair",
	...
	"material", "math", "matter", "maximum", "maze", "meadow", "meaning", "medal",
	...
	"ribbon", "right", "rigid", "ring", "riot", "ripple", "risk", "ritual",
	"rival", "river", "road", "roast", "robot", "robust", "rocket", "romance",
	"roof", "rookie", "rose", "rotate", "rough", "round", "route", "royal",
	...
	"save", "scale", "scan", "scare", "scatter", "scene", "scheme", "school",
	...
	"solar", "solution", "solve", "someone", "song", "soon", "sorry", "soul",
