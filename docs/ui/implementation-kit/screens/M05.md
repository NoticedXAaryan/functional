# M05 · Your message was received.

Target route: `/missing/received`. Layout: **child_single_column**. Design only.
...
4. Supporting text: “This has not automatically created a public alert.”
5. Choose how to come back.
6. Other ways to get help.
7. Primary button: **Choose how to come back**.
8. Secondary actions: Other ways to get help → C11.
...
Use tokens.css and the corresponding visual board. The board is composition guidance only; it is not a screenshot of a working service. Consult ../.. documents 02–06 for domain-specific validation and authorization. For M05, use the exact ID in the release checklist.

## Screen-specific rules override the generic recipe

Private receipt only. Do not offer public sharing of the report or a fabricated alert link.
